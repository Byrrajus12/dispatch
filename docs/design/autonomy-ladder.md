...
| 13  | Overseer mutating-action confirmations                                          | `overseerTools.ts:381-521`; `overseer.ts` (QUEUED_NOTE)                 | n/a — the overseer is the human's own console; its confirm protects against the chat model acting unilaterally, which no autonomy rung is a mandate for                                                  |
