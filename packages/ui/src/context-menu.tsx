...
// The shadcn `context-menu` primitive (new-york style) on radix-ui, the same
// library every other primitive in this package is built on. Opens on right
// click / long press at the pointer; the surface, item and separator styling
// mirror dropdown-menu.tsx so a context menu and a dropdown on the same page
// read as one system.
