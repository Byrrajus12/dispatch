...
// The panel slides in from its edge: Base UI marks the first and last frame
// with `data-starting-style`/`data-ending-style`, and the translate for each
// side is what those frames transition from and to.
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          'fixed z-50 flex flex-col gap-4 bg-background shadow-overlay transition-[translate,opacity] duration-300 ease-in-out outline-none data-ending-style:opacity-0 data-starting-style:opacity-0',
          side === 'right' &&
